                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            ?>
                            <form class="user" action="<?=base_url();?>Login/loguear" method="post" id="formulario" name="formulario">
                            ...
                            <br>
                            <div class="text-center">
                                <a class="small" href="<?=base_url();?>Login/formemail">¿Olvidó su contraseña?</a>
                            </div>
                            <hr>
                            <div class="text-center">
